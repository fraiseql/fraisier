...
class TestZFSSnapshotRetention:
    ...
    def test_cleanup_old_snapshots_with_prefix(self):
        ...
        snapshots = [
            ...
            Snapshot("zroot/data@backup_001", 1641168000, "1.2G", "700M"),  # Different prefix
        ...
        with patch.object(self.zfs_ops, 'list_snapshots') as mock_list:
            ...
            deleted = self.zfs_ops.cleanup_old_snapshots("zroot/data", keep_count=2, prefix="prod_")
    ...
    def test_cleanup_old_snapshots_with_age_filter(self):
        ...
        snapshots = [
            Snapshot("zroot/data@old", current_time - 86400*10, "1.0G", "512M"),  # 10 days old
            Snapshot("zroot/data@medium", current_time - 86400*3, "1.1G", "600M"),  # 3 days old
            Snapshot("zroot/data@new", current_time - 86400*1, "1.2G", "700M"),   # 1 day old
        ]
        ...
        with patch.object(self.zfs_ops, 'list_snapshots', return_value=snapshots):
            ...
            deleted = self.zfs_ops.cleanup_old_snapshots("zroot/data", keep_count=1, max_age_days=5.0)
    ...
    def test_cleanup_old_snapshots_age_only(self):
        ...
        snapshots = [
            Snapshot("zroot/data@very_old", current_time - 86400*10, "1.0G", "512M"),  # 10 days old
            Snapshot("zroot/data@old", current_time - 86400*6, "1.1G", "600M"),       # 6 days old
            Snapshot("zroot/data@new", current_time - 86400*1, "1.2G", "700M"),       # 1 day old
        ]
